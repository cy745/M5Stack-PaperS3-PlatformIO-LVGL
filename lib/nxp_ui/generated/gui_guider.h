...
typedef struct
{
	...
	lv_obj_t *home_screen_power_percent;
	lv_obj_t *home_screen_wifi_icon;
	lv_obj_t *home_screen_is_charging;
	lv_obj_t *home_screen_time;
	lv_obj_t *lock_screen;
	bool lock_screen_del;
	lv_obj_t *lock_screen_status_bar;
	lv_obj_t *lock_screen_power_percent;
	lv_obj_t *lock_screen_wifi_icon;
	lv_obj_t *lock_screen_is_charging;
	lv_obj_t *lock_screen_lock_time;
	lv_obj_t *lock_screen_lock_date;
}lv_ui;
